...
var translations = map[string]map[string]string{
	"de": {
		...
		"settings.killsound.desc":   "WAV-Datei abspielen wenn Kills erkannt werden.",
		"settings.killsound.browse": "Durchsuchen...",
		"settings.killsound.clear":  "Löschen",
	...
	"en": {
		...
		"settings.killsound":        "Kill Sound:",
		"settings.killsound.desc":   "Play a WAV file when kills are detected.",
		"settings.killsound.browse": "Browse...",
		"settings.killsound.clear":  "Clear",
		"settings.event":        "Kill Event:",
		"settings.save":     "Save",
